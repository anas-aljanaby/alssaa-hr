-- Allow re-check-in after checkout for overtime (e.g. return from break).
-- Previously: ALREADY_CHECKED_IN if check_in_time was set.
-- Now: only block if checked in AND not yet checked out.
